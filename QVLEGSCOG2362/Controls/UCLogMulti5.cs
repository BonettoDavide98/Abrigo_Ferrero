...
namespace QVLEGSCOG2362
{
    public partial class UCLogMulti5 : UserControl
    {
        ...
        private Utilities.CogWndCtrlManager hWndCtrlManager4 = null;
        private Utilities.CogWndCtrlManager hWndCtrlManager5 = null;
        ...
        public void SetData(Utilities.ObjectToDisplay[] iconicVarList, DataType.ElaborateResult[] result, DateTime ts)
        {
            ...
            if (iconicVarList.Length > 3) this.hWndCtrlManager4.DisplaySetupOutputCamera(iconicVarList[3].Clone(), result[3]);
            if (iconicVarList.Length > 4) this.hWndCtrlManager5.DisplaySetupOutputCamera(iconicVarList[4].Clone(), result[4]);
