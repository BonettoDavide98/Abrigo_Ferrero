...
namespace QVLEGSCOG2362.Pagine
{
    public partial class UCPaginaOnLine5Cam : UserControl, IUCPaginaOnLine
    {
        ...
        public void Init(Class.AppManager appManager, int idStazione, DataType.Impostazioni impostazioni, object repaintLock)
        {
            ...
            this.hWndCtrlManagerCamera4 = new Utilities.CogWndCtrlManager(panelCamera4, false, false);

            this.hWndCtrlManagerCamera5 = new Utilities.CogWndCtrlManager(panelCamera5, false, false);
        }
