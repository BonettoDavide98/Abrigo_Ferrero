...
{
    public partial class WizardDL : TSWizards.BaseWizard
    {

        #region Variabili Private

        private Algoritmi.AlgoritmoWizard algoritmoWizard = null;
        private readonly UCStepDL step1 = null;

        #endregion Variabili Private

        public WizardDL(Class.AppManager appManager, int idCamera, Class.CoreRegolazioni core, Algoritmi.AlgoritmoWizard algoritmoWizard, DataType.Impostazioni impostazioni, bool modifica, DBL.LinguaManager linguaManager, object repaintLock)
        {
            InitializeComponent();
            ...
            try
            {
                ...
                step1 = new UCStepDL(appManager, idCamera, core, this.algoritmoWizard, impostazioni, modifica, linguaManager, repaintLock);
        ...
        protected override void OnFinishClicked(EventArgs e)
        {
            ...
            this.algoritmoWizard.SetWizardDLComplete();
